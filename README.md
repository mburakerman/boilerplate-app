...
- Vite + TypeScript + React + TanStack Query + Tailwind CSS + FormatJS + React-Intl + Zustand + Zod + React Hook Form + React Helmet Async + Vitest + Testing Library + ESLint + Prettier
